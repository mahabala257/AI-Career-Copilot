...
export default function CompanyResearchPage() {
  ...
  const [result, setResult] = useState<CompanyResearchResponse | null>(null);

  const mutation = useMutation({
    mutationFn: () => companyApi.research({ company_name: companyName, target_role: targetRole }),
              ...
              <Card>
                <CardContent className="pt-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {r.skill_alignment.matching_skills.length > 0 && (
                      <div>
                    ...
                    {r.skill_alignment.missing_skills.length > 0 && (
                      <div>
