...
import { Heart, Loader2, AlertCircle, Sparkles, Phone, AlertTriangle } from "lucide-react";
...
export default function WellnessCoachPage() {
  ...
  const [result, setResult] = useState<WellnessCheckinResponse | null>(null);

  const mutation = useMutation({
    mutationFn: () => wellnessApi.checkin({ mood_message: moodMessage }),
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-4">
            <Textarea
              placeholder="e.g. I've failed 3 interviews this month and I'm starting to feel like giving up..."
              value={moodMessage}
            ...
            <>
              ...
              <Card>
                <CardContent className="pt-4 space-y-3">
                  ...
                  {r.burnout_risk.signals.length > 0 && (
